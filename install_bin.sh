...
USR_BIN_LIST=( 'zsh' 'xargs' 'find' 'tail' 'rsync' 'scp' 'tr' 'clear' 'perl' 'vi' 'curl' 'wget' 'basename' 'pager' 'git' 'git-receive-pack' 'git-shell' 'git-upload-archive' 'git-upload-pack' 'unzip' 'dirname' 'head' 'cut')
# Install required
